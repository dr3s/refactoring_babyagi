        ...
        while True:
            try:
                if model.lower().startswith("llama"):
                    ...
                    trimmed_prompt = self.limit_tokens_from_string(prompt, model, 4000 - max_tokens)
...
class BabyAGI:
    ...
    Unless your list is empty, do not include any headers before your numbered list or follow your numbered list with any other output."""
        ...
        response = self.openai_service.openai_call(prompt, max_tokens=2000)
    ...
    def execution_agent(self, objective: str, task: str) -> str:
        ...
        prompt += f'\nYour task: {task}\nResponse:'
        return self.openai_service.openai_call(prompt, max_tokens=2000)
    ...
    def run(self, objective, first_task):
        ...
        while loop:
            ...
            if not self.tasks_storage.is_empty() and runs < self.max_runs:
                ...
                result = self.execution_agent(OBJECTIVE, str(task["task_name"]))
